...
public:
	...
	std::vector<unsigned char> vchWhitelistAccount;
    ...
    friend bool operator==(const CEscrow &a, const CEscrow &b) {
		...
		&& a.vchWhitelistAccount == b.vchWhitelistAccount
    ...
    CEscrow operator=(const CEscrow &b) {
        ...
        vchOffer = b.vchOffer;
		vchWhitelistAccount = b.vchWhitelistAccount;
    ...
    void SetNull() { nHeight = 0; txHash.SetNull(); escrowInputTxHash.SetNull(); nQty = 0; nPricePerUnit = 0; vchBuyerKey.clear(); vchArbiterKey.clear(); vchSellerKey.clear(); vchRedeemScript.clear(); vchOffer.clear(); vchWhitelistAccount.clear(); rawTx.clear(); vchOfferAcceptLink.clear(); vchPaymentMessage.clear();}
