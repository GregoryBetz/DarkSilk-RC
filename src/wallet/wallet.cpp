...
CAmount CWalletTx::GetAnonymizableCredit(const bool& fUseCache) const
{
    if (pwallet == 0)
        return 0;
...
CAmount CWalletTx::GetDenominatedCredit(const bool& unconfirmed, const bool& fUseCache) const
{
    if (pwallet == 0)
        return 0;
